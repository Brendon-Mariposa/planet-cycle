...
<div class="flex flex-wrap -mt-48">
	<div class="flex flex-wrap w-11/12 mx-auto">
        <div class="flex flex-wrap w-8/12 bg-white mb-8 mx-auto shadow-lg rounded">
			<h4 class="w-full bg-color-222222 text-lg text-white p-3 uppercase">Get in Contact with Planet Cycle</h4>
            <div class="w-full p-8">
                <?php echo do_shortcode("[wpforms id='279' title='false' description='false']"); ?>
            </div>
        </div>
        <div class="w-3/12 mx-auto">
		    <div class="flex flex-wrap bg-white shadow-lg rounded">
			    <h4 class="w-full bg-color-222222 text-lg text-white p-3 uppercase">CONTACT US FOR PRICING DETAILS</h4>
