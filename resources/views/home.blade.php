...
<div class="flex flex-wrap items-center">
  ...
  <div class="flex flex-wrap w-11/12 md:w-1/5 items-center bg-color-33cc00 hover:bg-color-222222 h-16 mx-auto text-base font-bold uppercase hover:cursor-pointer">
